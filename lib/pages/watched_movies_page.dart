...
class WatchedMoviesListPage extends StatelessWidget {
  const WatchedMoviesListPage({super.key});
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          context.read<LibraryMovieRepositoryMemory>().removeMovieFromLibrary(libraryMovie.movie.id);
                        },
                      ),
                    ],
                  ),
